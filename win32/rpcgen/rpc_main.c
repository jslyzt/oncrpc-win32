...
#ifdef __BORLANDC__
char CPP[] = "cpp32";
char CPPFLAGS[] = "-C -P- -oCON";
#else
char CPP[] = "cl";
char CPPFLAGS[] = "/C /EP /nologo";
#endif
#else
char CPP[] = "/lib/cpp";
char CPPFLAGS[] = "-C";
...
int allc = sizeof(allv) / sizeof(allv[0]);

void c_output(char* infile, char* define, int extend, char* outfile);
void h_output(char* infile, char* define, int extend, char* outfile);
void s_output(int argc, char* argv[], char* infile, char* define, int extend, char* outfile, int nomain);
void l_output(char* infile, char* define, int extend, char* outfile);
void do_registers(int argc, char* argv[]);
 ...
 */
int parseargs(int argc, char* argv[], struct commandline* cmd) {
    int i;
    int j;
    char c;
