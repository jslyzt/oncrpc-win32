...
void get_declaration(declaration* dec, defkind dkind);
void unsigned_dec(char** typep);
void get_type(char** prefixp, char** typep, defkind dkind);

void isdefined(definition* defp) {
    STOREVAL(&defined, defp);
}


void def_struct(definition* defp) {
    token tok;
    declaration dec;
    decl_list* decls;
    decl_list** tailp;
...
void def_program(definition* defp) {
    token tok;
    version_list* vlist;
    version_list** vtailp;
    proc_list* plist;
...
void def_const(definition* defp) {
    token tok;
...
void def_union(definition* defp) {
    token tok;
    declaration dec;
    case_list* cases;
    case_list** tailp;
...
void def_typedef(definition* defp) {
    declaration dec;
