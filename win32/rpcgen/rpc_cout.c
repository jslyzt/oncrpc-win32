...
int findtype(definition* def, char* type) {
...
void print_header(definition* def) {
    space();
    f_print(fout, "bool_t\n");
...
void print_ifopen(int indent, char* name) {
    tabify(fout, indent);
    f_print(fout, "if (!xdr_%s(xdrs", name);
}


void print_ifarg(char* arg) {
    f_print(fout, ", %s", arg);
}


void print_ifsizeof(char* prefix, char* type) {
    if (streq(type, "bool")) {
...
void print_ifstat(int indent, char* prefix, char* type, relation rel, char* amax, char* objname, char* name) {
    char* alt = NULL;
...
void print_stat(declaration* dec) {
...
void emit_union(definition* def) {
    declaration* dflt;
    case_list* cl;
    declaration* cs;
    char* object;
...
void emit_typedef(definition* def) {
...
void emit_struct(definition* def) {
    decl_list* dl;
